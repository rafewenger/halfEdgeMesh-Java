...
/** Class for coordinate vectors operations, 
 *   including squared distance and lengths 
 *   and cosines of angles.
 * - Methods are static.
 */
public class ComputeCoord {
	...
	(float[] coord0, float[] coord1, FlagZero flag_zero)
	{
		...
		double magnitude0 = ComputeCoord.normalize_vector(coord0, temp_coord0);
		double magnitude1 = ComputeCoord.normalize_vector(coord1, temp_coord1);
		...
		double cos_angle =
			ComputeCoord.compute_inner_product(temp_coord0, temp_coord1);
			...
			FlagZero flag_zero)
	{
		...
		ComputeCoord.subtract_coord(coord0, coord1, vect0);
		ComputeCoord.subtract_coord(coord2, coord1, vect1);
